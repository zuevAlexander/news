...
class Twig_Environment
{
     ...
     *
     *  * charset: The charset used by the view (default to utf-8).
     *
     *  * base_template_class: The base template class to use for generated
     *                         view (default to Twig_Template).
     *
     *  * cache: An absolute path where to store the compiled view, or
     ...
     *
     *  * strict_variables: Whether to ignore invalid variables in view
     *                      (default to false).
     *
    ...
    /**
     * Gets the base template class for compiled view.
     *
    ...
    /**
     * Sets the base template class for compiled view.
     *
     ...
     *
     * @param string|false $cache The absolute path to the compiled view,
    ...
    public function resolveTemplate($names)
    {
        ...
        throw new Twig_Error_Loader(sprintf('Unable to find one of the following view: "%s".', implode('", "', $names)));
    }
